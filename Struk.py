...
GEDUNG MENARA INDOMARET      |==|OYOOMARET|==|
...
tambahbarang = input("Apakah ingin mengscan barang ? \n").lower()
...
# tunai = int(input("MASUKAN NOMINAL TUNAI : "))
# kembalian = tunai - hargatotal

print(f"""
----------------------------------------
{namabarang} {jumlahbarang} Pcs Rp.{hargabarang}     Rp.{hargatotal}
----------------------------------------
TOTAL   : {hargatotal}
TUNAI   : {tunai}
KENBALI : {kembalian}
